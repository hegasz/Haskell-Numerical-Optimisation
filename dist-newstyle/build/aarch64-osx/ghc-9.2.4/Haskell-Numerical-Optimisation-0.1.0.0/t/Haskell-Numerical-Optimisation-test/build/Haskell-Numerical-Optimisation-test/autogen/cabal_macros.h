...
/* package Haskell-Numerical-Optimisation-0.1.0.0 */
#ifndef VERSION_Haskell_Numerical_Optimisation
#define VERSION_Haskell_Numerical_Optimisation "0.1.0.0"
#endif /* VERSION_Haskell_Numerical_Optimisation */
#ifndef MIN_VERSION_Haskell_Numerical_Optimisation
#define MIN_VERSION_Haskell_Numerical_Optimisation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Numerical_Optimisation */
/* package Haskell-Numerical-Optimisation-0.1.0.0 */
#ifndef VERSION_Haskell_Numerical_Optimisation
#define VERSION_Haskell_Numerical_Optimisation "0.1.0.0"
#endif /* VERSION_Haskell_Numerical_Optimisation */
...
/* package hspec-discover-2.10.6 */
#ifndef VERSION_hspec_discover
#define VERSION_hspec_discover "2.10.6"
...
#define CURRENT_COMPONENT_ID "Haskell-Numerical-Optimisation-0.1.0.0-inplace-Haskell-Numerical-Optimisation-test"
